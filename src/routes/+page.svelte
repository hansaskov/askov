...
<div class="h-screen overflow-y-scroll snap-y snap-proximity pt-4">
	...
	<div
		class="flex justify-between navbar bg-base-100 bg-opacity-90 shadow-lg rounded-box sticky top-0 mx-4 w-auto max-w-full"
	>
		<div>
			<a href="/" class="btn btn-ghost text-2xl">Askov</a>
		</div>
		<div>
			<div class="dropdown">
				<!-- svelte-ignore a11y-no-noninteractive-tabindex -->
				<!-- svelte-ignore a11y-label-has-associated-control -->
				<label tabindex="0" class="btn text-2xl btn-ghost m-1">
					Tema
					<svg
						width="12px"
						height="12px"
				...
				<ul
					tabindex="0"
					class="dropdown-content z-[1] p-2 shadow-2xl bg-base-200 bg-opacity-90 rounded-box w-52"
				>
					<li>
						<input
							type="radio"
			...
			<a href="onskeliste" class="btn btn-ghost text-2xl">Ønskeliste</a>
		</div>
	</div>
