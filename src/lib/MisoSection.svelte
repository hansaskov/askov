<script>
	const images = [
		...
		{ path: 'images/miso_1.jpg', description: 'Miso slapper af og kigger på fugle' },
		{
			...
			description:
				'Miso ligger på gulvet og kigger på kameraet med et dybt og blodtørstigt blik. "Hvis bare jeg var stor nok til at spise den lækre mand"'
		},
...
<div class="bg-background text-text py-10" {...$$restProps}>
	<h1 class="text-5xl font-bold text-primary mb-8 text-center">Mød Miso, Vores ynglings kat</h1>
	<p class="text-lg text-center mb-16">Indtil videre ;)</p>
